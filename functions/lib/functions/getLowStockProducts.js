...
function isLowOrOut(item, outOnly) {
    if (outOnly) {
...
exports.getLowStockProducts = (0, https_1.onCall)(async (request) => {
    ...
    const outOnly = parseBoolean((_f = request.data) === null || _f === void 0 ? void 0 : _f.outOnly);
...
//# sourceMappingURL=getLowStockProducts.js.map